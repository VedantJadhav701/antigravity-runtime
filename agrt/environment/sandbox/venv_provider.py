...
from agrt.kernel.watchdog.process_watchdog import ProcessWatchdog
from agrt.environment.sandbox.attestation import AttestationEngine

logger = logging.getLogger("agrt.environment.venv")
...
class VenvProvider(SandboxInterface):
    ...
    def __init__(self, session_id: str, workspace_root: str, watchdog: Optional[ProcessWatchdog] = None):
        ...
        self.session_dir = os.path.join(self.workspace_root, ".agrt", "sessions", session_id)
        self.venv_dir = os.path.join(self.workspace_root, ".agrt", "environments", session_id)
