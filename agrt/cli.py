...
class AgrtCLI:
    ...
    def do_list(self):
        ...
        report_dir = "agrt/artifacts/execution_reports"
    ...
    def do_inspect(self, args):
        ...
        path = f"agrt/artifacts/execution_reports/{args.session_id}.json"
    ...
    def do_validate(self, args):
        ...
        from agrt.environment.validation.engine import ValidationEngine
        validator = ValidationEngine()
        
        files_to_validate = []
        ignore_dirs = {".agrt", "node_modules", "__pycache__", ".git"}
    ...
    def do_doctor(self):
        ...
        ws_ok = os.path.exists(".agrt")
        print(f"Workspace Infrastructure: {'OK' if ws_ok else 'Missing (.agrt)'}")
        print(f"Python Version:         {sys.version.split()[0]}")
        
        art_path = "agrt/artifacts"
        art_ok = os.path.exists(art_path)
        print(f"Artifact Store:         {'OK' if art_ok else 'Missing'}")
        
        temp_path = os.path.join(os.path.dirname(__file__), "generation", "templates")
