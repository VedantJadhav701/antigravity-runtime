...
logger = logging.getLogger("agrt.kernel.cleanup")
...
class CleanupManager:
    ...
    def __init__(self, workspace_root: str = "."):
        ...
        self.sessions_dir = os.path.join(self.workspace_root, ".agrt", "sessions")
        self.quarantine_dir = os.path.join(self.workspace_root, ".agrt", "quarantine")
        self.environments_dir = os.path.join(self.workspace_root, ".agrt", "environments")
    ...
    def quarantine_session(self, session_id: str, reason: str):
        """
        Relocates a session folder to .agrt/quarantine/ and saves metadata.
