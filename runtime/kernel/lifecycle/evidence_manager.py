...
from runtime.kernel.lifecycle.evidence import ExecutionEvidence

logger = logging.getLogger("runtime.kernel.evidence")

class EvidenceManager:
    """
    Handles the persistence and retrieval of 'Flight Logs'.
    """
    def __init__(self, storage_dir: str = ".runtime/history"):
